...
import { emailTemplate } from "../../../../templates/single-page/email/template1";
import { RSVPDetailsType } from "../../../../templates/single-page/reducer/RSVPInit";
...
export async function POST(request: Request) {
  ...
  const clientMessage: Mail.Options = {
    ...
    html: emailTemplate(hostname.live, clientname, data),
  };
        ...
        data: [
          {
            ...
            "Guest Names": data.guestNames
              ...
              .join(", "),
            "Attending?": data.areYouAttending === true ? "Yes" : "No",
          },
        ],
      }),
    }).catch((err: any) => {
